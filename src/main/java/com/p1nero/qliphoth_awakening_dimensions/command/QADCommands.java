    ...
    public static void registerCommands(RegisterCommandsEvent event) {
        ...
        dispatcher.register(Commands.literal(FDLib.MOD_ID)
                ...
                .then(Commands.literal("geburah_dim")
                        ...
                        .executes(commandContext -> {
                            if(commandContext.getSource().getPlayer() != null) {
                                commandContext.getSource().getPlayer().changeDimension(commandContext.getSource().getServer().getLevel(QADDimensions.GEBURAH_LEVEL_KEY), new GeburahBossSpawnerTeleporter());
                            }
                            return 0;
                        }))
        );
